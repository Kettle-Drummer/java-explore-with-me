...
public class PublicParticipationRequestController {
    ...
    public List<ParticipationRequestDto> getForOwnerEvent(@PathVariable @NotNull @Min(1L) Long userId,
        ...
        log.info("GET /users/{userId}/events/{eventId}/requests: list request get request for owner id={} event id={}",
                userId, eventId);
        return participationRequestService.getForOwnerEvent(userId, eventId);
    }
    ...
    public EventRequestStatusUpdateResult updateStatusForEventByOwnerAndID(
        ...
        return participationRequestService.updateStatusForEventByOwnerAndID(userId, eventId, eventRequestStatus);
    }
}
