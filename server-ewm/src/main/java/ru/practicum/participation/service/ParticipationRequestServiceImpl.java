...
import ru.practicum.participation.storage.ParticipationRequestRepository;
...
public class ParticipationRequestServiceImpl implements ParticipationRequestService {
    ...
    @Transactional
    @Override
    public ParticipationRequestDto addForEventId(Long userId, Long eventId) {
    ...
    @Transactional
    @Override
    public EventRequestStatusUpdateResult updateStatusForEventByOwnerAndID(
    ...
    @Transactional
    @Override
    public ParticipationRequestDto cancelForEventId(Long userId, Long requestId) {
    ...
    @Override
    public List<ParticipationRequestDto> getForOwnerEvent(Long userId, Long eventId) {
        Event event = getEvent(eventId);
        getExceptionIfEventIsNotThisUser(event.getInitiator(), userId);
        List<ParticipationRequest> participationRequests = participationRequestRepository
    ...
    @Transactional(readOnly = true)
    @Override
    public List<ParticipationRequestDto> getForUserForOthersEvents(Long userId) {
        List<ParticipationRequest> participationRequests = participationRequestRepository
