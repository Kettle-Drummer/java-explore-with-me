...
public class EventMapper {
    ...
    public Event toEvent(Event oldEvent, UpdateEventUserRequest request, Category categoryNew, Location location) {
        return Event.builder()
                .id(oldEvent.getId())
    ...
    public Event toEvent(Event oldEvent, UpdateEventAdminRequest request, Category categoryNew, Location location) {
        return Event.builder()
                .id(oldEvent.getId())
                .annotation(request.getAnnotation() != null ? request.getAnnotation() : oldEvent.getAnnotation())
                .category(request.getCategory() != null ? categoryNew : oldEvent.getCategory())
