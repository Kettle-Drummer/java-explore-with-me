...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDto add(Long eventId, Long userId, NewCommentDto newCommentDto) {
        ...
        Comment createComment = commentMapper.toComment(newCommentDto, event, user, parentComment);
    ...
    @Transactional
    @Override
    public CommentDto update(Long commentId, Long userId, UpdateCommentDto updateCommentDto) {
        Comment oldComment = getCommentByIdAndAuthor(commentId, userId);
        Comment updateComment = commentMapper.toComment(updateCommentDto, oldComment);
    ...
    @Transactional(readOnly = true)
    @Override
    public CommentDto getByIdByUser(Long commentId, Long userId) {
    ...
    @Transactional(readOnly = true)
    @Override
    public List<CommentFullDto> getAllByUserIdByAdmin(Long userId, Integer from, Integer size) {
        Pageable pageable = getPageable(from, size);
        List<Comment> allCommentsUser = commentRepository.findAllByAuthorId(userId, pageable)
                .orElse(new ArrayList<>());
    ...
    @Transactional(readOnly = true)
    @Override
    public List<CommentFullDto> searchByTextByAdmin(String text, Integer from, Integer size) {
        Pageable pageable = getPageable(from, size);
