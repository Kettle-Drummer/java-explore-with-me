...
public class AdminEventController {
    ...
    @PatchMapping("/{Id}")
    public EventFullDto updateAdmin(@Valid @RequestBody UpdateEventAdminRequest updateEventAdminRequest,
        ...
        return eventService.updateAdmin(updateEventAdminRequest, id);
    }
}
